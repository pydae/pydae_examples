...
if dae_file_mode == 'local':
    import vsc_l_cffi as jacs
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.vsc_l_cffi as jacs
...
class model: 
    ...
    def __init__(self): 
        ...
        self.params_values_list  = [R_s, L_s, C_eq, G_eq, R_g, L_g, Omega_b, C_dc, K_p_i, K_i_i, K_p_idc, K_i_idc, K_p_vc, K_i_vc, K_p_vdc, K_i_vdc] 
        ...
        self.outputs_list = ['i_q_ref', 'i_dc_ref', 'v_dc_ref', 'p_load', 'i_load'] 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, f'./vsc_l_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './vsc_l_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './vsc_l_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz(f'./{self.matrices_folder}/vsc_l_Hu_run_num.npz')        
