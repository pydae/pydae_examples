...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 8 
        self.N_store = 100000 
        self.params_list = ['R_s', 'L_s', 'R_g', 'L_g', 'K_delta'] 
        self.params_values_list  = [0.1, 0.001, 0.01, 0.0001, 0.001] 
        self.inputs_ini_list = ['v_ga', 'v_gb', 'v_gc', 'omega', 'eta_ta', 'eta_tb', 'eta_tc', 'v_dc'] 
        self.inputs_ini_values_list  = [326.5986323710904, -163.2993161855452, -163.2993161855452, 314.1592653589793, 0.8164965809277259, -0.40824829046386296, -0.40824829046386296, 800.0] 
        self.inputs_run_list = ['v_ga', 'v_gb', 'v_gc', 'omega', 'eta_ta', 'eta_tb', 'eta_tc', 'v_dc'] 
        self.inputs_run_values_list = [326.5986323710904, -163.2993161855452, -163.2993161855452, 314.1592653589793, 0.8164965809277259, -0.40824829046386296, -0.40824829046386296, 800.0] 
        self.outputs_list = ['i_sa', 'i_sb', 'i_sc', 'v_sa', 'v_sb', 'v_sc', 'v_gD', 'v_gQ'] 
        self.x_list = ['theta', 'i_sD', 'i_sQ'] 
        self.y_run_list = ['v_sD', 'v_sQ'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['v_sD', 'v_sQ'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 0, 1, 2, 0, 1, 2, 0, 1, 3, 0, 2, 4]
    sp_jac_ini_ja = [0, 1, 4, 7, 10, 13]
    sp_jac_ini_nia = 5
    sp_jac_ini_nja = 5
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 0, 1, 2, 0, 1, 2, 0, 1, 3, 0, 2, 4]
    sp_jac_run_ja = [0, 1, 4, 7, 10, 13]
    sp_jac_run_nia = 5
    sp_jac_run_nja = 5
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 0, 1, 2, 0, 1, 2, 0, 1, 3, 0, 2, 4]
    sp_jac_trap_ja = [0, 1, 4, 7, 10, 13]
    sp_jac_trap_nia = 5
    sp_jac_trap_nja = 5
