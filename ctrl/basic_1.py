...
class basic_1_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 2 
        self.N_store = 10000 
        self.params_list = ['C_1', 'C_2', 'C_3', 'C_4'] 
        self.params_values_list  = [1.0, 2.0, 3.0, 4.0] 
        self.inputs_ini_list = ['u_1', 'u_2'] 
        self.inputs_ini_values_list  = [1.0, 2.0] 
        self.inputs_run_list = ['u_1', 'u_2'] 
        self.inputs_run_values_list = [1.0, 2.0] 
        self.outputs_list = ['z_1', 'z_2'] 
        self.x_list = ['x_1', 'x_2'] 
        self.y_run_list = ['y_1', 'y_2'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['y_1', 'y_2'] 
        ...
        self.sp_jac_ini = sspa.load_npz('basic_1_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('basic_1_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('basic_1_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz('basic_1_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz('basic_1_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz('basic_1_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz('basic_1_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz('basic_1_Hu_run_num.npz')        
    ...
    def eval_jac_u2z(self):
        ...
        self.jac_u2z = Hxy_run @ sspa.linalg.spsolve(self.sp_jac_ini,-FGu_run) + self.sp_Hu_run        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 0, 1, 2, 3, 2, 0, 3]
    sp_jac_ini_ja = [0, 1, 5, 6, 8]
    sp_jac_ini_nia = 4
    sp_jac_ini_nja = 4
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 0, 1, 2, 3, 2, 0, 3]
    sp_jac_run_ja = [0, 1, 5, 6, 8]
    sp_jac_run_nia = 4
    sp_jac_run_nja = 4
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 0, 1, 2, 3, 2, 0, 3]
    sp_jac_trap_ja = [0, 1, 5, 6, 8]
    sp_jac_trap_nia = 4
    sp_jac_trap_nja = 4
