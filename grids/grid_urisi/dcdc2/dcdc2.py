...
if dae_file_mode == 'local':
    import dcdc2_cffi as jacs
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.dcdc2_cffi as jacs
if dae_file_mode == 'colab':
    import dcdc2_cffi as jacs
if dae_file_mode == 'testing':
    from pydae.temp import dcdc2_cffi as jacs
...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 14 
        self.N_store = 100000 
        self.params_list = ['R_h_D1', 'R_g_D1', 'A_D1', 'B_D1', 'C_D1', 'Droop_p_D1', 'Droop_i_D1', 'T_f_D1', 'R_h_D3', 'R_g_D3', 'A_D3', 'B_D3', 'C_D3', 'Droop_p_D3', 'Droop_i_D3', 'T_f_D3', 'R_h_D4', 'R_g_D4', 'R_h_D5', 'R_g_D5', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [0.01, 3, 2.92, 0.45, 0.027, 0.0, 0.0, 0.1, 0.01, 3, 2.92, 0.45, 0.027, 0.0, 0.0, 0.1, 0.0001, 3, 0.0001, 3, 0.01, 0.01, 0.01] 
        self.inputs_ini_list = ['p_load_D2', 'e_h_ref_D1', 'e_h_ref_D3', 'v_ref_D4', 'v_ref_D5', 'u_freq'] 
        self.inputs_ini_values_list  = [100000.0, 800, 800, 400, 400, 0.0] 
        self.inputs_run_list = ['p_load_D2', 'e_h_ref_D1', 'e_h_ref_D3', 'v_ref_D4', 'v_ref_D5', 'u_freq'] 
        self.inputs_run_values_list = [100000.0, 800, 800, 400, 400, 0.0] 
        self.outputs_list = ['i_l_D1_0_D2_0_r', 'i_l_D1_0_D2_0_i', 'i_l_D1_1_D2_1_r', 'i_l_D1_1_D2_1_i', 'i_l_D2_0_D3_0_r', 'i_l_D2_0_D3_0_i', 'i_l_D2_1_D3_1_r', 'i_l_D2_1_D3_1_i', 'm_h_D1', 'm_h_D3', 'p_h_D4', 'p_h_D5', 'xi_freq', 'u_freq'] 
        self.x_list = ['i_h_f_D1', 'i_h_f_D3', 'xi_freq'] 
        self.y_run_list = ['V_D1_0_r', 'V_D1_0_i', 'V_D1_1_r', 'V_D1_1_i', 'V_D2_0_r', 'V_D2_0_i', 'V_D2_1_r', 'V_D2_1_i', 'V_D3_0_r', 'V_D3_0_i', 'V_D3_1_r', 'V_D3_1_i', 'V_D4_0_r', 'V_D4_0_i', 'V_D4_1_r', 'V_D4_1_i', 'V_D5_0_r', 'V_D5_0_i', 'V_D5_1_r', 'V_D5_1_i', 'i_load_D2_p_r', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_D1_0_r', 'V_D1_0_i', 'V_D1_1_r', 'V_D1_1_i', 'V_D2_0_r', 'V_D2_0_i', 'V_D2_1_r', 'V_D2_1_i', 'V_D3_0_r', 'V_D3_0_i', 'V_D3_1_r', 'V_D3_1_i', 'V_D4_0_r', 'V_D4_0_i', 'V_D4_1_r', 'V_D4_1_i', 'V_D5_0_r', 'V_D5_0_i', 'V_D5_1_r', 'V_D5_1_i', 'i_load_D2_p_r', 'omega_coi', 'p_agc'] 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, f'./dcdc2_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz(f'{self.matrices_folder}/dcdc2_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './dcdc2_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz(f'{self.matrices_folder}/dcdc2_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './dcdc2_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz(f'{self.matrices_folder}/dcdc2_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz(f'{self.matrices_folder}/dcdc2_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz(f'{self.matrices_folder}/dcdc2_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz(f'{self.matrices_folder}/dcdc2_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz(f'{self.matrices_folder}/dcdc2_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz(f'{self.matrices_folder}/dcdc2_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 3, 5, 1, 11, 13, 2, 24, 0, 3, 5, 7, 4, 8, 0, 3, 5, 9, 6, 10, 3, 7, 11, 23, 4, 8, 12, 5, 9, 13, 23, 6, 10, 14, 1, 7, 11, 13, 8, 12, 1, 9, 11, 13, 10, 14, 0, 3, 5, 15, 17, 16, 0, 3, 5, 15, 17, 18, 1, 11, 13, 19, 21, 20, 1, 11, 13, 19, 21, 22, 7, 9, 23, 24, 2, 24, 25]
    sp_jac_ini_ja = [0, 3, 6, 8, 12, 14, 18, 20, 24, 27, 31, 34, 38, 40, 44, 46, 51, 52, 57, 58, 63, 64, 69, 70, 73, 74, 77]
    sp_jac_ini_nia = 26
    sp_jac_ini_nja = 26
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 3, 5, 1, 11, 13, 2, 24, 0, 3, 5, 7, 4, 8, 0, 3, 5, 9, 6, 10, 3, 7, 11, 23, 4, 8, 12, 5, 9, 13, 23, 6, 10, 14, 1, 7, 11, 13, 8, 12, 1, 9, 11, 13, 10, 14, 0, 3, 5, 15, 17, 16, 0, 3, 5, 15, 17, 18, 1, 11, 13, 19, 21, 20, 1, 11, 13, 19, 21, 22, 7, 9, 23, 24, 2, 24, 25]
    sp_jac_run_ja = [0, 3, 6, 8, 12, 14, 18, 20, 24, 27, 31, 34, 38, 40, 44, 46, 51, 52, 57, 58, 63, 64, 69, 70, 73, 74, 77]
    sp_jac_run_nia = 26
    sp_jac_run_nja = 26
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 3, 5, 1, 11, 13, 2, 24, 0, 3, 5, 7, 4, 8, 0, 3, 5, 9, 6, 10, 3, 7, 11, 23, 4, 8, 12, 5, 9, 13, 23, 6, 10, 14, 1, 7, 11, 13, 8, 12, 1, 9, 11, 13, 10, 14, 0, 3, 5, 15, 17, 16, 0, 3, 5, 15, 17, 18, 1, 11, 13, 19, 21, 20, 1, 11, 13, 19, 21, 22, 7, 9, 23, 24, 2, 24, 25]
    sp_jac_trap_ja = [0, 3, 6, 8, 12, 14, 18, 20, 24, 27, 31, 34, 38, 40, 44, 46, 51, 52, 57, 58, 63, 64, 69, 70, 73, 74, 77]
    sp_jac_trap_nia = 26
    sp_jac_trap_nja = 26
