...
if dae_file_mode == 'local':
    import cigre_eu_lv_res_3bus_cffi as jacs
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.cigre_eu_lv_res_3bus_cffi as jacs
...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 29 
        self.N_store = 100000 
        self.params_list = ['g_R01_0_R10_0_0', 'b_R01_0_R10_0_0', 'g_R01_0_R10_0_1', 'b_R01_0_R10_0_1', 'g_R01_0_R10_0_2', 'b_R01_0_R10_0_2', 'g_R01_0_R10_0_3', 'b_R01_0_R10_0_3', 'g_R01_1_R10_1_0', 'b_R01_1_R10_1_0', 'g_R01_1_R10_1_1', 'b_R01_1_R10_1_1', 'g_R01_1_R10_1_2', 'b_R01_1_R10_1_2', 'g_R01_1_R10_1_3', 'b_R01_1_R10_1_3', 'g_R01_2_R10_2_0', 'b_R01_2_R10_2_0', 'g_R01_2_R10_2_1', 'b_R01_2_R10_2_1', 'g_R01_2_R10_2_2', 'b_R01_2_R10_2_2', 'g_R01_2_R10_2_3', 'b_R01_2_R10_2_3', 'g_R01_3_R10_3_0', 'b_R01_3_R10_3_0', 'g_R01_3_R10_3_1', 'b_R01_3_R10_3_1', 'g_R01_3_R10_3_2', 'b_R01_3_R10_3_2', 'g_R01_3_R10_3_3', 'b_R01_3_R10_3_3', 'g_shunt_R01_3', 'b_shunt_R01_3', 'g_shunt_R10_3', 'b_shunt_R10_3', 'K_abc_R10', 'X_R00_s', 'R_R00_s', 'X_R00_sn', 'R_R00_sn', 'X_R00_ng', 'R_R00_ng', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [11.73019659035334, -6.007308085362264, -4.404358100646684, 1.1412637361501492, -2.773066643874354, 2.5872182756615576, -4.404358100646684, 1.141263736150148, -4.404358100646684, 1.1412637361501476, 11.730196590353346, -6.007308085362266, -4.404358100646686, 1.1412637361501483, -2.773066643874354, 2.587218275661561, -2.773066643874354, 2.587218275661559, -4.404358100646685, 1.1412637361501474, 11.730196590353346, -6.007308085362262, -4.404358100646685, 1.141263736150147, -4.404358100646684, 1.1412637361501474, -2.7730666438743543, 2.5872182756615607, -4.404358100646685, 1.1412637361501474, 11.730196590353344, -6.007308085362265, 0.3333333333333333, 0.0, 0.025, 0.0, 1.0, 0.1, 0.01, 0.1, 0.01, 0, 3, 0.01, 0.01, 0.01] 
        self.inputs_ini_list = ['p_load_R10_a', 'q_load_R10_a', 'g_load_R10_a', 'b_load_R10_a', 'p_load_R10_b', 'q_load_R10_b', 'g_load_R10_b', 'b_load_R10_b', 'p_load_R10_c', 'q_load_R10_c', 'g_load_R10_c', 'b_load_R10_c', 'e_ao_m_R00', 'e_bo_m_R00', 'e_co_m_R00', 'phi_R00', 'u_freq'] 
        ...
        self.inputs_run_list = ['p_load_R10_a', 'q_load_R10_a', 'g_load_R10_a', 'b_load_R10_a', 'p_load_R10_b', 'q_load_R10_b', 'g_load_R10_b', 'b_load_R10_b', 'p_load_R10_c', 'q_load_R10_c', 'g_load_R10_c', 'b_load_R10_c', 'e_ao_m_R00', 'e_bo_m_R00', 'e_co_m_R00', 'phi_R00', 'u_freq'] 
        ...
        self.outputs_list = ['i_l_R01_0_R10_0_r', 'i_l_R01_0_R10_0_i', 'i_l_R01_1_R10_1_r', 'i_l_R01_1_R10_1_i', 'i_l_R01_2_R10_2_r', 'i_l_R01_2_R10_2_i', 'i_l_R01_3_R10_3_r', 'i_l_R01_3_R10_3_i', 'i_t_R00_R01_1_0_r', 'i_t_R00_R01_1_0_i', 'i_t_R00_R01_1_1_r', 'i_t_R00_R01_1_1_i', 'i_t_R00_R01_1_2_r', 'i_t_R00_R01_1_2_i', 'i_t_R00_R01_2_0_r', 'i_t_R00_R01_2_0_i', 'i_t_R00_R01_2_1_r', 'i_t_R00_R01_2_1_i', 'i_t_R00_R01_2_2_r', 'i_t_R00_R01_2_2_i', 'i_t_R00_R01_2_3_r', 'i_t_R00_R01_2_3_i', 'i_vsc_R00_a_m', 'i_vsc_R00_b_m', 'i_vsc_R00_c_m', 'p_R00', 'q_R00', 'xi_freq', 'u_freq'] 
        self.x_list = ['xi_freq'] 
        self.y_run_list = ['V_R00_0_r', 'V_R00_0_i', 'V_R00_1_r', 'V_R00_1_i', 'V_R00_2_r', 'V_R00_2_i', 'V_R01_0_r', 'V_R01_0_i', 'V_R01_1_r', 'V_R01_1_i', 'V_R01_2_r', 'V_R01_2_i', 'V_R01_3_r', 'V_R01_3_i', 'V_R10_0_r', 'V_R10_0_i', 'V_R10_1_r', 'V_R10_1_i', 'V_R10_2_r', 'V_R10_2_i', 'V_R10_3_r', 'V_R10_3_i', 'i_load_R10_a_r', 'i_load_R10_a_i', 'i_load_R10_b_r', 'i_load_R10_b_i', 'i_load_R10_c_r', 'i_load_R10_c_i', 'i_load_R10_n_r', 'i_load_R10_n_i', 'i_vsc_R00_a_r', 'i_vsc_R00_b_r', 'i_vsc_R00_c_r', 'i_vsc_R00_a_i', 'i_vsc_R00_b_i', 'i_vsc_R00_c_i', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_R00_0_r', 'V_R00_0_i', 'V_R00_1_r', 'V_R00_1_i', 'V_R00_2_r', 'V_R00_2_i', 'V_R01_0_r', 'V_R01_0_i', 'V_R01_1_r', 'V_R01_1_i', 'V_R01_2_r', 'V_R01_2_i', 'V_R01_3_r', 'V_R01_3_i', 'V_R10_0_r', 'V_R10_0_i', 'V_R10_1_r', 'V_R10_1_i', 'V_R10_2_r', 'V_R10_2_i', 'V_R10_3_r', 'V_R10_3_i', 'i_load_R10_a_r', 'i_load_R10_a_i', 'i_load_R10_b_r', 'i_load_R10_b_i', 'i_load_R10_c_r', 'i_load_R10_c_i', 'i_load_R10_n_r', 'i_load_R10_n_i', 'i_vsc_R00_a_r', 'i_vsc_R00_b_r', 'i_vsc_R00_c_r', 'i_vsc_R00_a_i', 'i_vsc_R00_b_i', 'i_vsc_R00_c_i', 'omega_coi', 'p_agc'] 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, f'./cigre_eu_lv_res_3bus_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './cigre_eu_lv_res_3bus_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './cigre_eu_lv_res_3bus_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz(f'./{self.matrices_folder}/cigre_eu_lv_res_3bus_Hu_run_num.npz')        
