...
if dae_file_mode == 'local':
    import es_eu_cffi as jacs
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.es_eu_cffi as jacs
if dae_file_mode == 'colab':
    import es_eu_cffi as jacs
if dae_file_mode == 'testing':
    from pydae.temp import es_eu_cffi as jacs
...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 22 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_ES1_ESH', 'b_ES1_ESH', 'bs_ES1_ESH', 'g_ES2_ESH', 'b_ES2_ESH', 'bs_ES2_ESH', 'g_ESC_ESH', 'b_ESC_ESH', 'bs_ESC_ESH', 'U_ES1_n', 'U_ES2_n', 'U_ESC_n', 'U_ESH_n', 'Omega_b_ES1', 'S_n_ES1', 'H_ES1', 'T1d0_ES1', 'T1q0_ES1', 'X_d_ES1', 'X_q_ES1', 'X1d_ES1', 'X1q_ES1', 'D_ES1', 'R_a_ES1', 'K_delta_ES1', 'K_sec_ES1', 'K_sat_ES1', 'K_a_ES1', 'K_ai_ES1', 'T_a_ES1', 'T_b_ES1', 'T_e_ES1', 'E_min_ES1', 'E_max_ES1', 'Droop_ES1', 'T_gov_1_ES1', 'T_gov_2_ES1', 'T_gov_3_ES1', 'D_t_ES1', 'omega_ref_ES1', 'K_ci_gov_ES1', 'Omega_b_ES2', 'S_n_ES2', 'H_ES2', 'T1d0_ES2', 'T1q0_ES2', 'X_d_ES2', 'X_q_ES2', 'X1d_ES2', 'X1q_ES2', 'D_ES2', 'R_a_ES2', 'K_delta_ES2', 'K_sec_ES2', 'K_sat_ES2', 'K_a_ES2', 'K_ai_ES2', 'T_a_ES2', 'T_b_ES2', 'T_e_ES2', 'E_min_ES2', 'E_max_ES2', 'Droop_ES2', 'T_gov_1_ES2', 'T_gov_2_ES2', 'T_gov_3_ES2', 'D_t_ES2', 'omega_ref_ES2', 'K_ci_gov_ES2', 'S_n_ESC', 'K_pfr_ESC', 'K_h_ESC', 'K_qv_ESC', 'K_p_pll_ESC', 'K_i_pll_ESC', 'T_pll_ESC', 'K_theta_pll_ESC', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [1000000000, 0.0, -133.33333333333334, 0.0, 0.0, -133.33333333333334, 0.0, 0.0, -133.33333333333334, 0.0, 20000, 20000, 20000, 400000, 314.1592653589793, 10000000000.0, 6.5, 8, 0.4, 1.8, 1.7, 0.3, 0.55, 1, 0.0025, 0.0001, 1, 1.0, 100, 1e-06, 0.1, 0.1, 0.1, -10, 10, 0.05, 1, 1, 1, 0, 1.0, 1e-06, 314.1592653589793, 10000000000.0, 6.5, 8, 0.4, 1.8, 1.7, 0.3, 0.55, 1, 0.0025, 0, 0, 1.0, 100, 1e-06, 0.1, 0.1, 0.1, -10, 10, 0.05, 1, 1, 1, 0, 1.0, 1e-06, 10000000000.0, 0.0, 0.0, 0.0, 180, 3200, 0.02, 1.0, 0.01, 0.0001, 0.0] 
        self.inputs_ini_list = ['P_ES1', 'Q_ES1', 'P_ES2', 'Q_ES2', 'P_ESC', 'Q_ESC', 'P_ESH', 'Q_ESH', 'v_ref_ES1', 'v_pss_ES1', 'p_c_ES1', 'v_ref_ES2', 'v_pss_ES2', 'p_c_ES2', 'p_in_ESC', 'Dp_r_ESC', 'Dq_r_ESC', 'v_ref_ESC'] 
        self.inputs_ini_values_list  = [0, 0, 0, 0, 0, 0, 0, 0, 1.03, 0.0, 0.8, 1.03, 0.0, 0.8, 0.8, 0.0, 0.0, 1.0] 
        self.inputs_run_list = ['P_ES1', 'Q_ES1', 'P_ES2', 'Q_ES2', 'P_ESC', 'Q_ESC', 'P_ESH', 'Q_ESH', 'v_ref_ES1', 'v_pss_ES1', 'p_c_ES1', 'v_ref_ES2', 'v_pss_ES2', 'p_c_ES2', 'p_in_ESC', 'Dp_r_ESC', 'Dq_r_ESC', 'v_ref_ESC'] 
        self.inputs_run_values_list = [0, 0, 0, 0, 0, 0, 0, 0, 1.03, 0.0, 0.8, 1.03, 0.0, 0.8, 0.8, 0.0, 0.0, 1.0] 
        self.outputs_list = ['V_ES1', 'V_ES2', 'V_ESC', 'V_ESH', 'p_e_ES1', 'v_f_ES1', 'p_m_ES1', 'v_pss_ES1', 'v_ref_ES1', 'p_c_ES1', 'p_e_ES2', 'v_f_ES2', 'p_m_ES2', 'v_pss_ES2', 'v_ref_ES2', 'p_c_ES2', 'p_in_ESC', 'Dp_r_ESC', 'Dq_r_ESC', 'omega_pll_ESC', 'omega_pll_f_ESC', 'rocof_pll_ESC'] 
        self.x_list = ['delta_ES1', 'omega_ES1', 'e1q_ES1', 'e1d_ES1', 'x_ab_ES1', 'x_e_ES1', 'xi_v_ES1', 'x_gov_1_ES1', 'x_gov_2_ES1', 'delta_ES2', 'omega_ES2', 'e1q_ES2', 'e1d_ES2', 'x_ab_ES2', 'x_e_ES2', 'xi_v_ES2', 'x_gov_1_ES2', 'x_gov_2_ES2', 'theta_pll_ESC', 'xi_pll_ESC', 'omega_pll_f_ESC', 'rocof_pll_f_ESC', 'xi_freq'] 
        self.y_run_list = ['V_ES1', 'theta_ES1', 'V_ES2', 'theta_ES2', 'V_ESC', 'theta_ESC', 'V_ESH', 'theta_ESH', 'i_d_ES1', 'i_q_ES1', 'p_g_ES1', 'q_g_ES1', 'v_f_ES1', 'p_m_ref_ES1', 'p_m_ES1', 'i_d_ES2', 'i_q_ES2', 'p_g_ES2', 'q_g_ES2', 'v_f_ES2', 'p_m_ref_ES2', 'p_m_ES2', 'p_out_ESC', 'q_out_ESC', 'rocof_pll_ESC', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_ES1', 'theta_ES1', 'V_ES2', 'theta_ES2', 'V_ESC', 'theta_ESC', 'V_ESH', 'theta_ESH', 'i_d_ES1', 'i_q_ES1', 'p_g_ES1', 'q_g_ES1', 'v_f_ES1', 'p_m_ref_ES1', 'p_m_ES1', 'i_d_ES2', 'i_q_ES2', 'p_g_ES2', 'q_g_ES2', 'v_f_ES2', 'p_m_ref_ES2', 'p_m_ES2', 'p_out_ESC', 'q_out_ESC', 'rocof_pll_ESC', 'omega_coi', 'p_agc'] 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, f'./es_eu_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz(f'{self.matrices_folder}/es_eu_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './es_eu_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz(f'{self.matrices_folder}/es_eu_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './es_eu_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz(f'{self.matrices_folder}/es_eu_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz(f'{self.matrices_folder}/es_eu_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz(f'{self.matrices_folder}/es_eu_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz(f'{self.matrices_folder}/es_eu_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz(f'{self.matrices_folder}/es_eu_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz(f'{self.matrices_folder}/es_eu_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 48, 0, 1, 23, 24, 31, 32, 37, 48, 2, 31, 35, 3, 32, 4, 6, 23, 4, 5, 6, 23, 23, 7, 36, 7, 8, 9, 10, 48, 9, 10, 25, 26, 38, 39, 44, 48, 11, 38, 42, 12, 39, 13, 15, 25, 13, 14, 15, 25, 25, 16, 43, 16, 17, 18, 19, 27, 28, 48, 18, 27, 28, 18, 19, 20, 27, 28, 21, 47, 22, 48, 23, 24, 29, 30, 33, 23, 24, 29, 30, 34, 25, 26, 29, 30, 40, 25, 26, 29, 30, 41, 27, 28, 29, 30, 45, 27, 28, 29, 30, 46, 23, 24, 25, 26, 27, 28, 29, 30, 23, 24, 25, 26, 27, 28, 29, 30, 0, 2, 23, 24, 31, 32, 0, 3, 23, 24, 31, 32, 0, 23, 24, 31, 32, 33, 0, 23, 24, 31, 32, 34, 5, 35, 1, 31, 32, 36, 49, 1, 7, 8, 37, 9, 11, 25, 26, 38, 39, 9, 12, 25, 26, 38, 39, 9, 25, 26, 38, 39, 40, 9, 25, 26, 38, 39, 41, 14, 42, 10, 38, 39, 43, 49, 10, 16, 17, 44, 20, 21, 45, 20, 21, 27, 46, 18, 19, 20, 27, 28, 47, 1, 10, 48, 22, 48, 49]
    sp_jac_ini_ja = [0, 3, 11, 14, 16, 19, 23, 24, 26, 28, 31, 39, 42, 44, 47, 51, 52, 54, 56, 61, 64, 69, 71, 73, 78, 83, 88, 93, 98, 103, 111, 119, 125, 131, 137, 143, 145, 150, 154, 160, 166, 172, 178, 180, 185, 189, 192, 196, 202, 205, 208]
    sp_jac_ini_nia = 50
    sp_jac_ini_nja = 50
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 48, 0, 1, 23, 24, 31, 32, 37, 48, 2, 31, 35, 3, 32, 4, 6, 23, 4, 5, 6, 23, 23, 7, 36, 7, 8, 9, 10, 48, 9, 10, 25, 26, 38, 39, 44, 48, 11, 38, 42, 12, 39, 13, 15, 25, 13, 14, 15, 25, 25, 16, 43, 16, 17, 18, 19, 27, 28, 48, 18, 27, 28, 18, 19, 20, 27, 28, 21, 47, 22, 48, 23, 24, 29, 30, 33, 23, 24, 29, 30, 34, 25, 26, 29, 30, 40, 25, 26, 29, 30, 41, 27, 28, 29, 30, 45, 27, 28, 29, 30, 46, 23, 24, 25, 26, 27, 28, 29, 30, 23, 24, 25, 26, 27, 28, 29, 30, 0, 2, 23, 24, 31, 32, 0, 3, 23, 24, 31, 32, 0, 23, 24, 31, 32, 33, 0, 23, 24, 31, 32, 34, 5, 35, 1, 31, 32, 36, 49, 1, 7, 8, 37, 9, 11, 25, 26, 38, 39, 9, 12, 25, 26, 38, 39, 9, 25, 26, 38, 39, 40, 9, 25, 26, 38, 39, 41, 14, 42, 10, 38, 39, 43, 49, 10, 16, 17, 44, 20, 21, 45, 20, 21, 27, 46, 18, 19, 20, 27, 28, 47, 1, 10, 48, 22, 48, 49]
    sp_jac_run_ja = [0, 3, 11, 14, 16, 19, 23, 24, 26, 28, 31, 39, 42, 44, 47, 51, 52, 54, 56, 61, 64, 69, 71, 73, 78, 83, 88, 93, 98, 103, 111, 119, 125, 131, 137, 143, 145, 150, 154, 160, 166, 172, 178, 180, 185, 189, 192, 196, 202, 205, 208]
    sp_jac_run_nia = 50
    sp_jac_run_nja = 50
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 48, 0, 1, 23, 24, 31, 32, 37, 48, 2, 31, 35, 3, 32, 4, 6, 23, 4, 5, 6, 23, 6, 23, 7, 36, 7, 8, 9, 10, 48, 9, 10, 25, 26, 38, 39, 44, 48, 11, 38, 42, 12, 39, 13, 15, 25, 13, 14, 15, 25, 15, 25, 16, 43, 16, 17, 18, 19, 27, 28, 48, 18, 19, 27, 28, 18, 19, 20, 27, 28, 21, 47, 22, 48, 23, 24, 29, 30, 33, 23, 24, 29, 30, 34, 25, 26, 29, 30, 40, 25, 26, 29, 30, 41, 27, 28, 29, 30, 45, 27, 28, 29, 30, 46, 23, 24, 25, 26, 27, 28, 29, 30, 23, 24, 25, 26, 27, 28, 29, 30, 0, 2, 23, 24, 31, 32, 0, 3, 23, 24, 31, 32, 0, 23, 24, 31, 32, 33, 0, 23, 24, 31, 32, 34, 5, 35, 1, 31, 32, 36, 49, 1, 7, 8, 37, 9, 11, 25, 26, 38, 39, 9, 12, 25, 26, 38, 39, 9, 25, 26, 38, 39, 40, 9, 25, 26, 38, 39, 41, 14, 42, 10, 38, 39, 43, 49, 10, 16, 17, 44, 20, 21, 45, 20, 21, 27, 46, 18, 19, 20, 27, 28, 47, 1, 10, 48, 22, 48, 49]
    sp_jac_trap_ja = [0, 3, 11, 14, 16, 19, 23, 25, 27, 29, 32, 40, 43, 45, 48, 52, 54, 56, 58, 63, 67, 72, 74, 76, 81, 86, 91, 96, 101, 106, 114, 122, 128, 134, 140, 146, 148, 153, 157, 163, 169, 175, 181, 183, 188, 192, 195, 199, 205, 208, 211]
    sp_jac_trap_nia = 50
    sp_jac_trap_nja = 50
