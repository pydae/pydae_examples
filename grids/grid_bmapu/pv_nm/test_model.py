...
class model: 
    ...
    def __init__(self): 
        ...
        self.outputs_list = ['V_1', 'V_2', 'p_line_1_2', 'q_line_1_2', 'p_line_2_1', 'q_line_2_1', 'alpha_2', 'Dv_2', 'm_ref_1', 'v_sd_1', 'v_sq_1', 'lvrt_1', 'v_dc_v_1', 'v_ac_v_1', 'p_mp_1', 'i_pv_1', 'v_dc_1', 'p_s_1', 'q_s_1', 'v_ti_1', 'v_tr_1', 'i_si_1', 'i_sr_1', 'i_s_1'] 
        self.x_list = ['delta_2', 'Domega_2', 'Dv_2', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'omega_2', 'i_d_2', 'i_q_2', 'p_s_2', 'q_s_2', 'omega_coi', 'p_agc', 'v_dc_v_1', 'i_sq_ref_1', 'i_sd_ref_1', 'i_sr_1', 'i_si_1', 'p_s_1', 'q_s_1'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'omega_2', 'i_d_2', 'i_q_2', 'p_s_2', 'q_s_2', 'omega_coi', 'p_agc', 'v_dc_v_1', 'i_sq_ref_1', 'i_sd_ref_1', 'i_sr_1', 'i_si_1', 'p_s_1', 'q_s_1'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 8, 13, 1, 2, 3, 13, 4, 5, 6, 7, 20, 4, 5, 6, 7, 21, 4, 5, 6, 7, 11, 4, 5, 6, 7, 12, 1, 8, 0, 6, 7, 9, 10, 0, 2, 6, 7, 9, 10, 0, 6, 7, 9, 10, 11, 0, 6, 7, 9, 10, 12, 8, 13, 3, 13, 14, 15, 20, 4, 17, 4, 16, 4, 5, 16, 17, 18, 19, 4, 5, 16, 17, 18, 19, 4, 5, 18, 19, 20, 4, 5, 18, 19, 21]
    sp_jac_ini_ja = [0, 3, 4, 5, 7, 12, 17, 22, 27, 29, 34, 40, 46, 52, 54, 57, 59, 61, 63, 69, 75, 80, 85]
    sp_jac_ini_nia = 22
    sp_jac_ini_nja = 22
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 8, 13, 1, 2, 3, 13, 4, 5, 6, 7, 20, 4, 5, 6, 7, 21, 4, 5, 6, 7, 11, 4, 5, 6, 7, 12, 1, 8, 0, 6, 7, 9, 10, 0, 2, 6, 7, 9, 10, 0, 6, 7, 9, 10, 11, 0, 6, 7, 9, 10, 12, 8, 13, 3, 13, 14, 15, 20, 4, 17, 4, 16, 4, 5, 16, 17, 18, 19, 4, 5, 16, 17, 18, 19, 4, 5, 18, 19, 20, 4, 5, 18, 19, 21]
    sp_jac_run_ja = [0, 3, 4, 5, 7, 12, 17, 22, 27, 29, 34, 40, 46, 52, 54, 57, 59, 61, 63, 69, 75, 80, 85]
    sp_jac_run_nia = 22
    sp_jac_run_nja = 22
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 8, 13, 1, 2, 3, 13, 4, 5, 6, 7, 20, 4, 5, 6, 7, 21, 4, 5, 6, 7, 11, 4, 5, 6, 7, 12, 1, 8, 0, 6, 7, 9, 10, 0, 2, 6, 7, 9, 10, 0, 6, 7, 9, 10, 11, 0, 6, 7, 9, 10, 12, 8, 13, 3, 13, 14, 15, 20, 4, 17, 4, 16, 4, 5, 16, 17, 18, 19, 4, 5, 16, 17, 18, 19, 4, 5, 18, 19, 20, 4, 5, 18, 19, 21]
    sp_jac_trap_ja = [0, 3, 4, 5, 7, 12, 17, 22, 27, 29, 34, 40, 46, 52, 54, 57, 59, 61, 63, 69, 75, 80, 85]
    sp_jac_trap_nia = 22
    sp_jac_trap_nja = 22
