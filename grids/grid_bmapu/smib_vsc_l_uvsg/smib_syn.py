...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 10 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'S_n_1', 'Omega_b_1', 'H_1', 'T1d0_1', 'T1q0_1', 'X_d_1', 'X_q_1', 'X1d_1', 'X1q_1', 'D_1', 'R_a_1', 'K_delta_1', 'K_sec_1', 'K_a_1', 'K_ai_1', 'T_r_1', 'T_a_1', 'T_b_1', 'E_fmin_1', 'E_fmax_1', 'T_wo_1', 'T_1_1', 'T_2_1', 'T_3_1', 'T_4_1', 'K_stab_1', 'V_lim_1', 'S_n_2', 'F_n_2', 'X_v_2', 'R_v_2', 'K_delta_2', 'K_alpha_2', 'K_rocov_2', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [20000.0, 19230.769230769227, -96153.84615384614, -0.0025, 20000.0, 20000.0, 100000000.0, 314.1592653589793, 5.0, 8.0, 0.4, 1.8, 1.7, 0.3, 0.55, 1.0, 0.01, 0.0, 0.0, 200, 1e-06, 0.01, 1, 10, -5, 10.0, 10.0, 0.05, 0.02, 3.0, 5.4, 20, 0.1, 1000000000.0, 50.0, 0.001, 0.0, 0.001, 1e-06, 1e-06, 0.0, 0.0, 0.01] 
        ...
        self.outputs_list = ['V_1', 'V_2', 'p_line_1_2', 'q_line_1_2', 'p_line_2_1', 'q_line_2_1', 'p_e_1', 'v_f_1', 'p_m_1', 'alpha_2'] 
        self.x_list = ['delta_1', 'omega_1', 'e1q_1', 'e1d_1', 'v_r_1', 'x_ab_1', 'xi_v_1', 'x_wo_1', 'x_12_1', 'x_34_1', 'delta_2', 'Domega_2', 'Dv_2', 'xi_freq'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 29, 0, 1, 14, 15, 18, 19, 29, 2, 18, 22, 3, 19, 4, 14, 4, 5, 23, 4, 23, 1, 7, 1, 7, 8, 1, 7, 8, 9, 10, 24, 29, 11, 12, 13, 29, 14, 15, 16, 17, 20, 14, 15, 16, 17, 21, 14, 15, 16, 17, 27, 14, 15, 16, 17, 28, 0, 2, 14, 15, 18, 19, 0, 3, 14, 15, 18, 19, 0, 14, 15, 18, 19, 20, 0, 14, 15, 18, 19, 21, 4, 5, 6, 22, 23, 1, 7, 8, 9, 23, 11, 24, 10, 16, 17, 25, 26, 10, 12, 16, 17, 25, 26, 10, 16, 17, 25, 26, 27, 10, 16, 17, 25, 26, 28, 1, 24, 29, 13, 29, 30]
    sp_jac_ini_ja = [0, 3, 10, 13, 15, 17, 20, 22, 24, 27, 31, 34, 35, 36, 38, 43, 48, 53, 58, 64, 70, 76, 82, 87, 92, 94, 99, 105, 111, 117, 120, 123]
    sp_jac_ini_nia = 31
    sp_jac_ini_nja = 31
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 29, 0, 1, 14, 15, 18, 19, 29, 2, 18, 22, 3, 19, 4, 14, 4, 5, 23, 4, 23, 1, 7, 1, 7, 8, 1, 7, 8, 9, 10, 24, 29, 11, 12, 13, 29, 14, 15, 16, 17, 20, 14, 15, 16, 17, 21, 14, 15, 16, 17, 27, 14, 15, 16, 17, 28, 0, 2, 14, 15, 18, 19, 0, 3, 14, 15, 18, 19, 0, 14, 15, 18, 19, 20, 0, 14, 15, 18, 19, 21, 4, 5, 6, 22, 23, 1, 7, 8, 9, 23, 11, 24, 10, 16, 17, 25, 26, 10, 12, 16, 17, 25, 26, 10, 16, 17, 25, 26, 27, 10, 16, 17, 25, 26, 28, 1, 24, 29, 13, 29, 30]
    sp_jac_run_ja = [0, 3, 10, 13, 15, 17, 20, 22, 24, 27, 31, 34, 35, 36, 38, 43, 48, 53, 58, 64, 70, 76, 82, 87, 92, 94, 99, 105, 111, 117, 120, 123]
    sp_jac_run_nia = 31
    sp_jac_run_nja = 31
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 29, 0, 1, 14, 15, 18, 19, 29, 2, 18, 22, 3, 19, 4, 14, 4, 5, 23, 4, 6, 23, 1, 7, 1, 7, 8, 1, 7, 8, 9, 10, 24, 29, 11, 12, 13, 29, 14, 15, 16, 17, 20, 14, 15, 16, 17, 21, 14, 15, 16, 17, 27, 14, 15, 16, 17, 28, 0, 2, 14, 15, 18, 19, 0, 3, 14, 15, 18, 19, 0, 14, 15, 18, 19, 20, 0, 14, 15, 18, 19, 21, 4, 5, 6, 22, 23, 1, 7, 8, 9, 23, 11, 24, 10, 16, 17, 25, 26, 10, 12, 16, 17, 25, 26, 10, 16, 17, 25, 26, 27, 10, 16, 17, 25, 26, 28, 1, 24, 29, 13, 29, 30]
    sp_jac_trap_ja = [0, 3, 10, 13, 15, 17, 20, 23, 25, 28, 32, 35, 36, 37, 39, 44, 49, 54, 59, 65, 71, 77, 83, 88, 93, 95, 100, 106, 112, 118, 121, 124]
    sp_jac_trap_nia = 31
    sp_jac_trap_nja = 31
