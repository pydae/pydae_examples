...
class model: 
    ...
    def __init__(self): 
        ...
        self.params_values_list  = [100000000.0, 3.846153846153846, -19.23076923076923, -5e-07, 400.0, 400.0, 100000000.0, 50.0, 0.001, 0.0, 0.001, 1e-06, 1e-06, 1000000.0, 25, 250, 3.87, 3.56, 33.7, 42.1, 72, -0.16, 0.065, 0.5602, 1862, 1.3433, 100, 0.01, 0.05, 10.5, 0.005, 0.005, 0.005, 0.0, 0.0, 0.01] 
