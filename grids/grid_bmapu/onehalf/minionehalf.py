...
import minionehalf_cffi as jacs
...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 2 
        self.N_store = 100000 
        self.params_list = ['T_g', 'H', 'D', 'F_n', 'Droop', 'H_cis', 'E_cis_0', 'K_cis'] 
        self.params_values_list  = [1.0, 5.0, 0.1, 50.0, 0.05, 2.0, 0.5, 0.001] 
        self.inputs_ini_list = ['p_c', 'p_cis', 'p_l', 'u_dummy'] 
        self.inputs_ini_values_list  = [0.8, 0.0, 0.8, 1.0] 
        self.inputs_run_list = ['p_c', 'p_cis', 'p_l', 'u_dummy'] 
        self.inputs_run_values_list = [0.8, 0.0, 0.8, 1.0] 
        self.outputs_list = ['p_f', 'p_cis'] 
        self.x_list = ['p_g', 'omega', 'e_cis'] 
        ...
        self.sp_jac_ini = sspa.load_npz('./__pycache__/minionehalf_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('./__pycache__/minionehalf_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('./__pycache__/minionehalf_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('./__pycache__/minionehalf_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('./__pycache__/minionehalf_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('./__pycache__/minionehalf_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('./__pycache__/minionehalf_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('./__pycache__/minionehalf_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 0, 1, 2, 3]
    sp_jac_ini_ja = [0, 2, 4, 5, 6]
    sp_jac_ini_nia = 4
    sp_jac_ini_nja = 4
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 0, 1, 2, 3]
    sp_jac_run_ja = [0, 2, 4, 5, 6]
    sp_jac_run_nia = 4
    sp_jac_run_nja = 4
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 0, 1, 2, 3]
    sp_jac_trap_ja = [0, 2, 4, 5, 6]
    sp_jac_trap_nia = 4
    sp_jac_trap_nja = 4
