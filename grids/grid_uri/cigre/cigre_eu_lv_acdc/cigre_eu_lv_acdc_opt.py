...
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.cigre_eu_lv_acdc_opt_cffi as jacs
...
class model: 
    ...
    def __init__(self): 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './cigre_eu_lv_acdc_opt_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz('./cigre_eu_lv_acdc_opt_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './cigre_eu_lv_acdc_opt_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz('./cigre_eu_lv_acdc_opt_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './cigre_eu_lv_acdc_opt_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz('./cigre_eu_lv_acdc_opt_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz('./cigre_eu_lv_acdc_opt_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz('./cigre_eu_lv_acdc_opt_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz('./cigre_eu_lv_acdc_opt_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz('./cigre_eu_lv_acdc_opt_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz('./cigre_eu_lv_acdc_opt_Hu_run_num.npz')        
