...
class rl_dq_class: 
    ...
    def __init__(self): 
        ...
        self.inputs_ini_list = ['v_d', 'v_q', 'omega', 'u_dummy'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 314.1592653589793, 1.0] 
        self.inputs_run_list = ['v_d', 'v_q', 'omega', 'u_dummy'] 
        self.inputs_run_values_list = [0.0, 0.0, 314.1592653589793, 1.0] 
        self.outputs_list = ['v_d', 'v_q'] 
        self.x_list = ['i_d', 'i_q'] 
        ...
        self.sp_jac_ini = sspa.load_npz('rl_dq_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('rl_dq_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('rl_dq_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('rl_dq_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('rl_dq_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('rl_dq_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('rl_dq_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('rl_dq_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 0, 1, 2]
    sp_jac_ini_ja = [0, 2, 4, 5]
    sp_jac_ini_nia = 3
    sp_jac_ini_nja = 3
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 0, 1, 2]
    sp_jac_run_ja = [0, 2, 4, 5]
    sp_jac_run_nia = 3
    sp_jac_run_nja = 3
