...
import im_emag_dq_cffi as jacs
...
class im_emag_dq_class: 
    ...
    def __init__(self): 
        ...
        self.sp_jac_ini = sspa.load_npz('im_emag_dq_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('im_emag_dq_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('im_emag_dq_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('im_emag_dq_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('im_emag_dq_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('im_emag_dq_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('im_emag_dq_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('im_emag_dq_Hu_run_num.npz')        
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 2, 0, 1, 3, 0, 2, 3, 4, 1, 2, 3, 4, 4, 5, 0, 1, 2, 3, 5]
    sp_jac_run_ja = [0, 3, 6, 10, 14, 16, 21]
    sp_jac_run_nia = 6
    sp_jac_run_nja = 6
