...
class ima_class: 
    ...
    def __init__(self): 
        ...
        self.sp_jac_ini = sspa.load_npz('ima_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('ima_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('ima_sp_jac_trap_num.npz')
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 1, 2, 3, 4, 5, 2, 3, 4, 2, 3, 5, 0, 2, 4, 5, 0, 3, 4, 5]
    sp_jac_run_ja = [0, 2, 7, 10, 13, 17, 21]
    sp_jac_run_nia = 6
    sp_jac_run_nja = 6
