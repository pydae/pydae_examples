...
import im_emag_abc_cffi as jacs
...
class im_emag_abc_class: 
    ...
    def __init__(self): 
        ...
        self.inputs_ini_list = ['v_sa', 'v_sb', 'v_sc', 'tau_l', 'omega'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 0.0, 0, 0] 
        self.inputs_run_list = ['v_sa', 'v_sb', 'v_sc', 'tau_l', 'omega'] 
        self.inputs_run_values_list = [0.0, 0.0, 0.0, 0, 0] 
        self.outputs_list = ['i_sd', 'i_sq', 'i_rd', 'i_rq', 'i_pk', 'tau_b', 'tau_l', 'p_s', 'q_s', 'v_sd', 'v_sq', 'i_sa', 'i_sb', 'i_sc', 'v_sa', 'v_sb', 'v_sc'] 
        self.x_list = ['lambda_sd', 'lambda_sq', 'lambda_rd', 'lambda_rq', 'omega_r', 'theta'] 
        ...
        self.sp_jac_ini = sspa.load_npz('im_emag_abc_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('im_emag_abc_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('im_emag_abc_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('im_emag_abc_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('im_emag_abc_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('im_emag_abc_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('im_emag_abc_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('im_emag_abc_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 2, 5, 0, 1, 3, 5, 0, 2, 3, 4, 1, 2, 3, 4, 4, 6, 5, 0, 1, 2, 3, 6]
    sp_jac_ini_ja = [0, 4, 8, 12, 16, 18, 19, 24]
    sp_jac_ini_nia = 7
    sp_jac_ini_nja = 7
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 2, 5, 0, 1, 3, 5, 0, 2, 3, 4, 1, 2, 3, 4, 4, 6, 5, 0, 1, 2, 3, 6]
    sp_jac_run_ja = [0, 4, 8, 12, 16, 18, 19, 24]
    sp_jac_run_nia = 7
    sp_jac_run_nja = 7
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 2, 5, 0, 1, 3, 5, 0, 2, 3, 4, 1, 2, 3, 4, 4, 6, 5, 0, 1, 2, 3, 6]
    sp_jac_trap_ja = [0, 4, 8, 12, 16, 18, 19, 24]
    sp_jac_trap_nia = 7
    sp_jac_trap_nja = 7
