...
class imdp_class: 
    ...
    def __init__(self): 
        ...
        self.y_run_list = ['tau_r0r', 'tau_r0i', 'tau_r2r', 'tau_r2i'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['tau_r0r', 'tau_r0i', 'tau_r2r', 'tau_r2i'] 
        ...
        self.sp_jac_ini = sspa.load_npz('imdp_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('imdp_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('imdp_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('imdp_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('imdp_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('imdp_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('imdp_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('imdp_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 2, 0, 1, 3, 0, 2, 3, 4, 8, 9, 1, 2, 3, 4, 7, 9, 4, 20, 5, 6, 7, 5, 6, 8, 3, 4, 5, 7, 8, 9, 2, 4, 6, 7, 8, 9, 9, 21, 10, 11, 12, 15, 10, 11, 13, 16, 10, 12, 13, 14, 17, 18, 19, 11, 12, 13, 14, 17, 18, 19, 14, 19, 22, 10, 15, 16, 17, 11, 15, 16, 18, 12, 13, 14, 15, 17, 18, 19, 12, 13, 14, 16, 17, 18, 19, 14, 19, 23, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 20, 0, 1, 2, 3, 5, 6, 7, 8, 21, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 22, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 23]
    sp_jac_ini_ja = [0, 3, 6, 12, 18, 20, 23, 26, 32, 38, 40, 44, 48, 55, 62, 65, 69, 73, 80, 87, 90, 107, 116, 133, 150]
    sp_jac_ini_nia = 24
    sp_jac_ini_nja = 24
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 2, 0, 1, 3, 0, 2, 3, 4, 8, 9, 1, 2, 3, 4, 7, 9, 4, 20, 5, 6, 7, 5, 6, 8, 3, 4, 5, 7, 8, 9, 2, 4, 6, 7, 8, 9, 9, 21, 10, 11, 12, 15, 10, 11, 13, 16, 10, 12, 13, 14, 17, 18, 19, 11, 12, 13, 14, 17, 18, 19, 14, 19, 22, 10, 15, 16, 17, 11, 15, 16, 18, 12, 13, 14, 15, 17, 18, 19, 12, 13, 14, 16, 17, 18, 19, 14, 19, 23, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 20, 0, 1, 2, 3, 5, 6, 7, 8, 21, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 22, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 23]
    sp_jac_run_ja = [0, 3, 6, 12, 18, 20, 23, 26, 32, 38, 40, 44, 48, 55, 62, 65, 69, 73, 80, 87, 90, 107, 116, 133, 150]
    sp_jac_run_nia = 24
    sp_jac_run_nja = 24
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 2, 0, 1, 3, 0, 2, 3, 4, 8, 9, 1, 2, 3, 4, 7, 9, 4, 20, 5, 6, 7, 5, 6, 8, 3, 4, 5, 7, 8, 9, 2, 4, 6, 7, 8, 9, 9, 21, 10, 11, 12, 15, 10, 11, 13, 16, 10, 12, 13, 14, 17, 18, 19, 11, 12, 13, 14, 17, 18, 19, 14, 19, 22, 10, 15, 16, 17, 11, 15, 16, 18, 12, 13, 14, 15, 17, 18, 19, 12, 13, 14, 16, 17, 18, 19, 14, 19, 23, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 20, 0, 1, 2, 3, 5, 6, 7, 8, 21, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 22, 0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 23]
    sp_jac_trap_ja = [0, 3, 6, 12, 18, 20, 23, 26, 32, 38, 40, 44, 48, 55, 62, 65, 69, 73, 80, 87, 90, 107, 116, 133, 150]
    sp_jac_trap_nia = 24
    sp_jac_trap_nja = 24
