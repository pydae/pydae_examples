...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 3 
        self.N_store = 100000 
        self.params_list = ['mass_vh', 'g', 'Cr', 'dens_air', 'Cd', 'Af', 'G', 'R', 'ng'] 
        self.params_values_list  = [1540, 9.81, 0.0048, 1.25, 0.19, 2, 6, 0.26, 0.95] 
        self.inputs_ini_list = ['Torque', 'slope', 'u_dummy'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 1.0] 
        self.inputs_run_list = ['Torque', 'slope', 'u_dummy'] 
        self.inputs_run_values_list = [0.0, 0.0, 1.0] 
        self.outputs_list = ['w_mot', 'pot', 'accel'] 
        self.x_list = ['vel_vh'] 
