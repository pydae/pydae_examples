...
class model: 
    ...
    def __init__(self): 
        ...
        self.x_list = ['nu'] 
        self.y_run_list = ['snu', 'omega_r'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['snu', 'omega_r'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 0, 1, 0, 2]
    sp_jac_ini_ja = [0, 2, 4, 6]
    sp_jac_ini_nia = 3
    sp_jac_ini_nja = 3
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 0, 1, 0, 2]
    sp_jac_run_ja = [0, 2, 4, 6]
    sp_jac_run_nia = 3
    sp_jac_run_nja = 3
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 0, 1, 0, 2]
    sp_jac_trap_ja = [0, 2, 4, 6]
    sp_jac_trap_nia = 3
    sp_jac_trap_nja = 3
